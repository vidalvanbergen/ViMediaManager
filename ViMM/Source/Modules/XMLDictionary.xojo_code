...
Protected Module XMLDictionary
	...
	#tag Method, Flags = &h21
		Private Function ExportXML(Extends xmldict as Dictionary, plist as Boolean = False, indented as Boolean = true) As XmlDocument
	...
	#tag Method, Flags = &h21
		Private Function ExportXMLString(Extends xmldict as Dictionary, plist as Boolean = False, indented as Boolean = true) As String
	...
	#tag Method, Flags = &h21
		Private Function LoadXML(Extends xmldict As Dictionary, XMLFile As FolderItem) As Boolean
	...
	#tag Method, Flags = &h21
		Private Function LoadXML(Extends xmldict As Dictionary, XMLData As String) As Boolean
		  Dim xdoc As XmlDocument
	...
	#tag Method, Flags = &h21
		Private Function LoadXML(Extends xmldict As Dictionary, XMLDoc As XmlDocument) As Boolean
		  Dim node As XmlNode
	...
	#tag Method, Flags = &h21
		Private Function SaveXML(Extends xmldict as Dictionary, XMLFile as FolderItem, plist as Boolean = False, indented as Boolean = true) As Boolean
